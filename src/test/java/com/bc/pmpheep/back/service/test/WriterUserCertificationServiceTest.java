...
public class WriterUserCertificationServiceTest extends BaseTest {
	...
	public void test() throws Exception {
		...
		WriterUserCertification writerUserCertification = new WriterUserCertification(new Long(random.nextInt(200)),
				new Long(random.nextInt(200)), String.valueOf(random.nextInt(200)), "512345678901111111",
				new Short("1"), "jjj", null, null);
		logger.info(
				"---WriterUserCertificationService测试---------------------------------------------------------------------------------");
		// 新增
		...
		String[] userId = { "1", "2" };
		Assert.assertTrue("",
				writerUserCertificationService.updateWriterUserCertificationProgressByUserId(progress, userId) >= 0);
	}
