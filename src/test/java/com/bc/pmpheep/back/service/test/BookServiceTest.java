...
public class BookServiceTest extends BaseTest{
	...
	public void serviceAllMethodTest(){
		 // add 图书添加
		Book book=bookService.add(new Book("生理学", "1234", "1", "作者", "出版社", null , 1, 
				1L, null, null, 99D, 9D, "http:www.baidu.com", "d://ee", "d://aa", 0L, 0L, 0L,
				0L, true, 999, null, true, 999, null, true, 999, null, 0L, true, null, null));
...
//		Assert.assertTrue("查询的时候返回pageResult.getRows当前页面不为空", pageResult.getRows().size() > 0 ? true : false);
		// updateBookById 修改
		Long [] ids={1L,2L,3L};
