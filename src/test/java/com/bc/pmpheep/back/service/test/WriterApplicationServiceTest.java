 ...
 * @修改人：tyc
 */
public class WriterApplicationServiceTest extends BaseTest {  
...
//	}
	...
	Logger logger = LoggerFactory.getLogger(WriterApplicationServiceTest.class);
	
	@Resource
	WriterApplicationService writerApplicationService;
