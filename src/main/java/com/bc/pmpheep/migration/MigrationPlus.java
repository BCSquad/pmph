...
public class MigrationPlus {
	 ...
	 public void initCmsAdvertisementData() {
	        ...
	        String dataJson
	                ...
	                + "{adname:'首页原重点推荐',	    type:0,autoPlay:false,animationInterval:0,   image:[{image:'/upload/article/20170328/zhongdiantuijian1.png'},{image:'/upload/article/20170328/zhongdiantuijian2.png'}]} ,"
