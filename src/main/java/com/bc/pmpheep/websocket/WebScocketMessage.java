...
public class WebScocketMessage {
	...
	public WebScocketMessage(String id, Short msgType, Long senderId,
			String senderName, Short senderType, Short sendType, String title,
	...
	public String toString() {
		return "{id:" + id + ", msgType:" + msgType + ", senderId:" + senderId
				+ ", senderName:" + senderName + ", senderType:" + senderType
				+ ", sendType:" + sendType + ", title:" + title + ", content:"
				+ content + ", time:" + time + "}";
	}
