...
public class PmphDepartmentController {
	 ...
	 * @param parentId
	 */
	@RequestMapping("/getPmphDepartmentTree")
	@ResponseBody
	public ResponseBean getPmphDepartmentTree(Long parentId){
		return  new ResponseBean(pmphDepartmentService.getListPmphDepartment(parentId));
	}
	 ...
	 */
	@RequestMapping("/addPmphDepartment")
	@ResponseBody
	 ...
	 * @return 影响行数
	 */
	@RequestMapping("/updatePmphDepartment")
	@ResponseBody
	 ...
	 * @return
	 */
	@RequestMapping("/deletePmphDepartmentBatch")
	@ResponseBody
