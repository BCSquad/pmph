...
public class UserMessageController {
	...
	public ResponseBean listSendOject(@RequestParam("sendType") Integer sendType,
		...
		return new ResponseBean(userMessageService.listSendOject(sendType, pageNumber, pageSize, orgName,
	...
	public ResponseBean addUserMessage(Message message, @RequestParam("title") String title,
		...
		try {
			return new ResponseBean(userMessageService.addOrUpdateUserMessage(message, title, sendType, orgIds, userIds,
					bookids, true, files, sessionId));
		} catch (IOException e) {
	...
	@ResponseBody
	public ResponseBean listMyMessage(Integer pageSize, Integer pageNumber, String title, Boolean isRead, Long userId,
			Integer userType) {
	...
	@ResponseBody
	public ResponseBean listMyMessageOfIcon(Integer pageSize, Integer pageNumber, Long userId, Integer userType) {
		PageParameter<MyMessageVO> pageParameter = new PageParameter<>(pageNumber, pageSize);
		MyMessageVO myMessageVO = new MyMessageVO();
		myMessageVO.setUserId(userId);
		myMessageVO.setUserType(userType);
