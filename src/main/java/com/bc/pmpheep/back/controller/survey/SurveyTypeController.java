 ...
 */
@Controller
@RequestMapping(value = "/survey/type")
...
public class SurveyTypeController {
    ...
    // 当前业务类型
    private static final String BUSSINESS_TYPE = "问卷调查类型";
     ...
     */
    @ResponseBody
    @LogDetail(businessType = BUSSINESS_TYPE, logRemark = "获取问卷调查类型集合")
     ...
     */
    @ResponseBody
    @LogDetail(businessType = BUSSINESS_TYPE, logRemark = "新增问卷调查类型")
     ...
     */
    @ResponseBody
    @LogDetail(businessType = BUSSINESS_TYPE, logRemark = "更新问卷调查类型")
