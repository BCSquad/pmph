...
public class MaterialController {
    ...
    public ResponseBean material(MaterialVO materialVO, HttpServletRequest request,
    MultipartFile[] noticeFiles, MultipartFile[] noteFiles) {
    ...
    public ResponseBean material(HttpServletRequest request, MaterialVO materialVO,
    MultipartFile[] noticeFiles, MultipartFile[] noteFiles) {
        String sessionId = CookiesUtil.getSessionId(request);
        return new ResponseBean(
                                materialService.addOrUpdateMaterial(sessionId,
