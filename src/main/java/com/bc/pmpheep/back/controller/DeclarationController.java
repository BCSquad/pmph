	...
	* @return
	...
	public ResponseBean selection(@RequestParam("textbookId") Long textbookId,
		...
		return new ResponseBean(
				decPositionService.listEditorSelection(textbookId, materialId, realName, presetPosition));
	}
	...
	public ResponseBean update(@RequestParam("jsonDecPosition") String jsonDecPosition,
		...
		try {
			return new ResponseBean(
					decPositionService.updateDecPositionEditorSelection(jsonDecPosition, selectionType, sessionId));
		} catch (IOException e) {
