...
public class BaiduCountController {
    ...
    @RequestParam("pageSize") String pageSize, @RequestParam("siteId") String siteId) {
    ...
    Long type, String path) {
        PageParameter<BookPreferenceAnalysisVO> pageParameter =
    ...
    String pageNum, String pageSize, String siteId) {
        // 默认前一个月
