...
public class Const {
    ...
    // WRITER_USER_TOKEN
    public static final String               SEESION_WRITER_USER_TOKEN     =
                                                                           "sessionWriterUserToken";
    // PMPH_USER_TOKEN
    ...
    // 图片上传路径
    public static final String               FILE_PATH_IMG                 =
                                                                           "uploadFiles/uploadImgs/";
    // 文件上传路径
    public static final String               MSG_FILE_PATH_FILE            =
                                                                           "d:/msg/uploadFiles/file/";
    // 文件上传路径
    ...
    public static final String               CMS_FILE_DOWNLOAD             =
                                                                           "/pmpheep/file/cms/download/";
    // material教材通知附件下载Controller方法
    public static final String               MATERIAL_NOTICE_FILE_DOWNLOAD =
                                                                           "/pmpheep/file/notice/download/";
    public static final String               MATERIAL_NOTE_FILE_DOWNLOAD   =
                                                                           "/pmpheep/file/note/download/";
    // 作者类型--系统
