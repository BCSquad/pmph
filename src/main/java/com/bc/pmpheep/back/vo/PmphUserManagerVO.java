...
public class PmphUserManagerVO implements java.io.Serializable {
    ...
    public String toString() {
        return "PmphUserManagerVO [id=" + id + ", name=" + name + ", username=" + username
               + ", isDisabled=" + isDisabled + ", realname=" + realname + ", path=" + path
               + ", departmentName=" + departmentName + ", pmphRoles=" + pmphRoles + ", handphone="
