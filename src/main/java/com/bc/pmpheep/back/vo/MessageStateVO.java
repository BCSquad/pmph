...
public class MessageStateVO implements Serializable{
		...
		public String toString() {
			return "{id:" + id + ", msgId:" + msgId + ", senderId:" + senderId
					+ ", isRead:" + isRead + ", msgType:" + msgType
					+ ", sendTime:" + sendTime + ", reciveTime:" + reciveTime
					+ ", name:" + name + ", dptname:" + dptname
					+ ", handphone:" + handphone + ", receiverType:"
					+ receiverType + ", isWithdraw:" + isWithdraw + ", count:"
					+ count + "}";
		}
