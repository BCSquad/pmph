...
public interface PmphUserDao {
     ...
     * @return Integer
     */
    Integer totalEditors(@Param("departmentId") Long departmentId,
     ...
     */
    List<PmphEditorVO> listEditors(@Param("departmentId") Long departmentId,
    @Param("realName") String realName, @Param("pageSize") Integer pageSize,
