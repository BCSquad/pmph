...
public interface WriterUserCertificationDao {
	 ...
	 * </pre>
	 */
	Integer updateWriterUserCertificationProgressByUserId(List<WriterUserCertification> writerUserCertification);
	...
	/**
	 * 
	 * @introduction 根据userId查询 WriterUserCertification
	 * @author Mryang
	 * @createDate 2017年9月19日 上午9:51:41
	 * @param id
	 * @return WriterUserCertification
	 */
	WriterUserCertification getWriterUserCertificationByUserId(Long userId);
}
