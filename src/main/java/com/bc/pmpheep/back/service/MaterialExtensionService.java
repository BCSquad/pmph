...
public interface MaterialExtensionService {
     ...
     * @param materialId thorws CheckedServiceException
     * @return
     */
     ...
     * @return 带主键的 MaterialExtension thorws CheckedServiceException
     */
    MaterialExtension addMaterialExtension(MaterialExtension materialExtension)
    throws CheckedServiceException;
