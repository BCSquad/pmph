...
public interface UserMessageService {
	 ...
	 * @return
	 */
	Integer addOrUpdateUserMessage(Message message, Integer sendType, String orgIds, String userIds, String bookIds,
			boolean isSave) throws CheckedServiceException, IOException;
