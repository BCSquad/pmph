...
public class WxAccountCrawlerServiceImpl extends BreadthCrawler implements WxAccountCrawlerService{
    ...
    public WxAccountCrawlerServiceImpl(String crawlPath, String historyKeysPath) throws Exception {
    ...
    public static void main(String[] args) throws Exception {
    	WxAccountCrawlerServiceImpl crawler = new WxAccountCrawlerServiceImpl("crawl_weixin", "wx_history.txt");
