...
public class MaterialServiceImpl extends BaseService implements MaterialService {
    ...
    throws CheckedServiceException {
        ...
        gson.fromJson(materialProjectEditors, new TypeToken<ArrayList<MaterialProjectEditor>>() {
        }.getType());
        ...
        if (!StringUtil.isEmpty(materialNoteAttachments)) {
            ...
            gson.fromJson(materialNoteAttachments,
