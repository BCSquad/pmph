    ...
    boolean isUpdate) throws CheckedServiceException, IOException {
        if (null == request.getSession(false)) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "会话过期");
        }
        // 获取当前用户
        ...
        if (isUpdate && (null == material.getId())) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "教材更新时主键为空");
        }
        // 教材名称的验证
        ...
        if (null == material.getMaterialRound()) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "教材轮次为空");
        }
        // 显示报名截止时间
        if (null == material.getDeadline()) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "显示报名截止时间为空");
        }
...
//                                              "显示报名截止时间必须大于当前时间");
        ...
        if (null == material.getActualDeadline()) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "实际报名截止日期为空");
        }
...
//                                              "实际报名截止日期必须大于当前时间");
        ...
        if (null == material.getAgeDeadline()) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.ILLEGAL_PARAM, "年龄计算截止日期为空");
        }
        // 邮寄地址验证
        if (StringUtil.isEmpty(material.getMailAddress())) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "邮寄地址为空");
        }
        if (material.getMailAddress().length() > 100) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.ILLEGAL_PARAM, "邮寄地址过长");
        }
        // 教材类型验证
        String materialType = materialVO.getMaterialType();
        if (StringUtil.isEmpty(materialType)) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "教材类型为空");
        }
        if (null == material.getDirector()) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "教材主任为空");
        }
        // 教材通知备注内容验证
        ...
        if (null == director) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.ILLEGAL_PARAM, "找不到对应的主任");
        ...
        // 扩展项转换
        List<MaterialExtension> oldMaterialExtensionlist =
        ...
        if (!StringUtil.isEmpty(materialExtensions)) {
            ...
            gson.fromJson(materialExtensions, new TypeToken<ArrayList<MaterialExtension>>() {
            }.getType());
        ...
        if (StringUtil.isEmpty(materialContacts)) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.ILLEGAL_PARAM, "教材联系人参数有误");
        }
        List<MaterialContact> materialContactlist =
        gson.fromJson(materialContacts, new TypeToken<ArrayList<MaterialContact>>() {
        }.getType());
        if (null == materialContactlist || materialContactlist.size() == 0) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "教材联系人为空");
        }
        for (MaterialContact materialContact : materialContactlist) {
            if (null == materialContact) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "教材联系人对象为空");
            }
            if (null == materialContact.getContactUserId()) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "联系人为空");
            }
            ...
            if (materialContact.getContactUserName().length() > 20) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "联系人姓名太长");
            }
            if (StringUtil.isEmpty(materialContact.getContactPhone())) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "联系电话为空");
            }
            if (materialContact.getContactPhone().length() > 25) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "联系电话太长");
            }
            if (StringUtil.isEmpty(materialContact.getContactEmail())) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "联系邮箱为空");
            }
            if (materialContact.getContactEmail().length() > 40) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "联系邮箱太长");
            }
        ...
        if (StringUtil.isEmpty(materialProjectEditors)) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.ILLEGAL_PARAM, "教材项目编辑参数有误");
        }
        List<MaterialProjectEditorVO> materialProjectEditorVOlist =
        gson.fromJson(materialProjectEditors, new TypeToken<ArrayList<MaterialProjectEditorVO>>() {
        }.getType());
        for (MaterialProjectEditorVO materialProjectEditorVO : materialProjectEditorVOlist) {
            if (null == materialProjectEditorVO || null == materialProjectEditorVO.getEditorId()) {
                throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                                  CheckedExceptionResult.NULL_PARAM, "项目编辑为空");
            }
        ...
        gson.fromJson(materialNoticeAttachments,
        ...
        for (MaterialNoticeAttachment materialNoticeAttachment : materialNoticeAttachmentlist) {
            if (null == materialNoticeAttachment.getId()) {
                ...
                String fileName =
                (String) request.getSession(false).getAttribute("fileName_" + tempFileId);
                ;
                ...
                fileService.save(sbs,
                                 fileName,
                                 FileType.MATERIAL_NOTICE_ATTACHMENT,
        ...
        gson.fromJson(materialNoteAttachments, new TypeToken<ArrayList<MaterialNoteAttachment>>() {
        }.getType());
        // 原来的备注文件
        List<MaterialNoteAttachment> oldMaterialNoteAttachmentlist =
        ...
        /**
         * // 判断教材备注附件和教材通知附件 List<MaterialNoticeAttachment> materialNoticeAttachmentlist = new
         * ArrayList<MaterialNoticeAttachment>(5); String
         * materialNoticeAttachments=materialVO.getMaterialNoticeAttachments(); if
         * (!StringUtil.isEmpty(materialNoticeAttachments)) { materialNoticeAttachmentlist =
         * gson.fromJson(materialNoticeAttachments, new
         * TypeToken<ArrayList<MaterialNoticeAttachment>>() { }.getType()); } if (null !=
         * noticeFiles && noticeFiles.length > 0) { for (MultipartFile notice : noticeFiles) { if
         * (null == notice || !(notice instanceof MultipartFile)) { throw new
         * CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         * CheckedExceptionResult.NULL_PARAM, "教材通知附件为空"); } if (notice.getName().length() > 80) {
         * throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         * CheckedExceptionResult.ILLEGAL_PARAM, "教材通知附件文件名过长"); } } } if ((null == noticeFiles &&
         * materialNoticeAttachmentlist.size() == 0) || (materialNoticeAttachmentlist.size() +
         * noticeFiles.length == 0)) {// 已有的数量加上新增的数量 throw new
         * CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         * CheckedExceptionResult.NULL_PARAM, "教材通知附件为空"); } List<MaterialNoteAttachment>
         * materialNoteAttachmentList = new ArrayList<MaterialNoteAttachment>(5); String
         * materialNoteAttachments = materialVO.getMaterialNoteAttachments(); if
         * (!StringUtil.isEmpty(materialNoteAttachments)) { materialNoteAttachmentList =
         * gson.fromJson(materialNoteAttachments, new TypeToken<ArrayList<MaterialNoteAttachment>>()
         * { }.getType()); } if (null != noteFiles && noteFiles.length > 0) { for (MultipartFile
         * note : noteFiles) { if (null == note || !(note instanceof MultipartFile)) { throw new
         * CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         * CheckedExceptionResult.NULL_PARAM, "教材备注附件为空"); } if (note.getName().length() > 80) {
         * throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         * CheckedExceptionResult.ILLEGAL_PARAM, "教材备注附件文件名过长"); } } } if ((null == noteFiles &&
         * materialNoteAttachmentList.size() == 0) || (materialNoteAttachmentList.size() +
         * noteFiles.length == 0)) {// 已有的数量加上新增的数量 throw new
         * CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         ...
         * CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         * CheckedExceptionResult.NULL_PARAM, "教材通知id为空"); } newMaterialNoticeAttachmentIds +=
         * materialNoticeAttachment.getId() + ","; } if (null != noticeFiles && noticeFiles.length >
         * 0) { for (MultipartFile notice : noticeFiles) { MaterialNoticeAttachment
         ...
         * materialNoticeAttachmentService.updateMaterialNoticeAttachment(materialNoticeAttachment);
         * newMaterialNoticeAttachmentIds += materialNoticeAttachment.getId() + ","; } } for
         * (MaterialNoticeAttachment materialNoticeAttachment : oldMaterialNoticeAttachmentlist) {
         * if (!newMaterialNoticeAttachmentIds.contains("," + materialNoticeAttachment.getId() +
         * ",")) {// 不包含 fileService.remove(materialNoticeAttachment.getAttachment()); // 删除文件
         * materialNoticeAttachmentService
         * .deleteMaterialNoticeAttachmentById(materialNoticeAttachment.getId()); } } // 保存教材备注附件
         * List<MaterialNoteAttachment> oldMaterialNoteAttachmentlist =
         * materialNoteAttachmentService
         * .getMaterialNoteAttachmentByMaterialExtraId(materialExtra.getId()); String
         * newMaterialNoteAttachmentIds = ","; for (MaterialNoteAttachment materialNoteAttachment :
         * materialNoteAttachmentList) { if (null == materialNoteAttachment.getId()) { throw new
         * CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
         * CheckedExceptionResult.NULL_PARAM, "教材备注id为空"); } newMaterialNoteAttachmentIds +=
         * materialNoteAttachment.getId() + ","; } if (null != noteFiles && noteFiles.length > 0) {
         * for (MultipartFile note : noteFiles) { MaterialNoteAttachment materialNoteAttachment =
         * new MaterialNoteAttachment(); materialNoteAttachment.setAttachment("---------");
         ...
         * materialNoteAttachmentService.addMaterialNoteAttachment(materialNoteAttachment); String
         * noticeId; // 保存备注文件 noticeId = fileService.save(note,
         ...
         * (MaterialNoteAttachment materialNoteAttachment : oldMaterialNoteAttachmentlist) { if
         * (!newMaterialNoteAttachmentIds.contains("," + materialNoteAttachment.getId() + ",")) {//
         * 不包含 fileService.remove(materialNoteAttachment.getAttachment()); // 删除文件
         * materialNoteAttachmentService
    ...
    throws CheckedServiceException {
        ...
        for (PmphRole pmphRole : pmphRoles) {
            if (null != pmphRole && null != pmphRole.getRoleName()
                && "系统管理员".equals(pmphRole.getRoleName())) {
                // 我是系统管理原
        ...
        if (null != material && null != material.getDirector()
            && pmphUser.getId().equals(material.getDirector())) {
            projectEditorPowers = 255; // 我是教材的主任
            role = (0 == role.intValue() ? 2 : role);
        }
        // 教材项目编辑检查
        List<MaterialProjectEditorVO> materialProjectEditors =
        materialProjectEditorService.listMaterialProjectEditors(materialId);
        ...
        MaterialMainInfoVO materialMainInfoVO =
        new MaterialMainInfoVO(materialId, material.getMaterialName(), material.getIsPublished(),
                               material.getIsAllTextbookPublished(), material.getIsForceEnd(),
                               material.getIsDeleted(),
                               StringUtil.tentToBinary(projectEditorPowers), role);
     ...
     */
    @Override
    public Integer updateMaterial(Material material, String sessionId)
    throws CheckedServiceException {
    ...
    @Override
    public PageResult<MaterialListVO> listMaterials(PageParameter<MaterialListVO> pageParameter,
    String sessionId) throws CheckedServiceException {
        ...
        if (null != pageParameter.getParameter().getIsMy()
            && !pageParameter.getParameter().getIsMy()) {
            pageParameter.getParameter().setIsMy(null);
        }
        if (!ObjectUtil.isNull(pageParameter.getParameter().getIsMy())
            && pageParameter.getParameter().getIsMy()) {
    ...
    public List<MaterialListVO> addMaterialContact(List<MaterialListVO> list, String sessionId) {
        ...
        for (MaterialListVO materialListVO : list) {
            ...
            if (!ObjectUtil.isNull(materialProjectEditorService.getMaterialProjectEditorByMaterialIdAndUserId(materialListVO.getId(),
                                                                                                              pmphUser.getId()))) {// 判断是否为项目编辑
                materialListVO.setIsMy(true);
            }
            if (!CollectionUtil.isEmpty(textbookService.getTextbookByMaterialIdAndUserId(materialListVO.getId(),
                                                                                         pmphUser.getId()))) {// 判断是否为策划编辑
                materialListVO.setIsMy(true);
            }
            ...
            materialListVO.setMyPower(getMaterialMainInfoById(materialListVO.getId(), sessionId).getMyPower());
        }
        return list;
    }
    ...
    public MaterialVO getMaterialVO(Long id) throws CheckedServiceException {
        ...
        materialTypeService.getMaterialTypeById(material.getMaterialType());
        String mtype = "[]";
        if (null != materialType) {
            mtype =
            "[" + materialType.getPath().replace("-", ",") + "," + material.getMaterialType() + "]";
        ...
        // 通知附件信息
        List<MaterialNoticeAttachment> materialNoticeAttachmentList =
        new ArrayList<MaterialNoticeAttachment>(5);
        if (null != materialExtra) {
            materialNoticeAttachmentList =
            materialNoticeAttachmentService.getMaterialNoticeAttachmentsByMaterialExtraId(materialExtra.getId());
        }
        String materialNoticeAttachments = gson.toJson(materialNoticeAttachmentList);
        // 通知备注附件信息
        List<MaterialNoteAttachment> materialNoteAttachmentList =
        new ArrayList<MaterialNoteAttachment>(5);
        if (null != materialExtra) {
            materialNoteAttachmentList =
            materialNoteAttachmentService.getMaterialNoteAttachmentByMaterialExtraId(materialExtra.getId());
        }
        String materialNoteAttachments = gson.toJson(materialNoteAttachmentList);

        return new MaterialVO(material, director == null ? null : director.getRealname(), mtype,
                              materialExtra, materialContacts, materialExtensions,
                              materialProjectEditorVOs, materialNoticeAttachments,
    ...
    throws CheckedServiceException, IOException {
        ...
        if (null == pmphUser) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "用户没有登录!");
        }
        if (null == files || files.length == 0) {
            throw new CheckedServiceException(CheckedExceptionBusiness.MATERIAL,
                                              CheckedExceptionResult.NULL_PARAM, "没有文件");
        }
