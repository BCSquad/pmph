...
public interface DecPositionService {
	 ...
	 * </pre>
	 */
	Map<String, Object> listEditorSelection(Long textbookId, Long materialId, String realName, String orgName
			) throws CheckedServiceException;
	 ...
	 * </pre>
	 */
	List<Long> getDecPositionIdByBookId(Long textbookId, Integer editorOrSubeditorType) throws CheckedServiceException;
	 ...
	 * </pre>
	 */
	Integer updateDecPositionSetDefault(List<Long> ids, Integer editorOrSubeditorType) throws CheckedServiceException;
	 ...
	 * </pre>
	 */
	PageResult<TextBookDecPositionVO> listDeclarationByTextbookIds(PageParameter<TextBookDecPositionVO> pageParameter)
			throws CheckedServiceException;
	 ...
	 * </pre>
	 */
	Integer batchPublishEditor(List<Long> textbookIds, String sessionId) throws CheckedServiceException, IOException;
