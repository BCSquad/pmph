...
/**
 * <p>Title:DecPositionServiceImpl<p>
...
public class DecPositionServiceImpl implements DecPositionService{
	...
	@Override
	public DecPosition decPosition(DecPosition decPosition)
	...
	@Override
	public Integer updateDecPosition(DecPosition decPosition)
			throws CheckedServiceException {
	...
	@Override
	public List<DecPosition> listDecPositions(Long declarationId)
			throws CheckedServiceException {
