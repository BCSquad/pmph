...
public class MaterialProjectEditorServiceImpl extends BaseService implements MaterialProjectEditorService {
	...
	@Override
	public MaterialProjectEditor addMaterialProjectEditor(MaterialProjectEditor materialProjectEditor)
	...
	@Override
	public Integer addMaterialProjectEditors(List<MaterialProjectEditor> materialProjectEditors)
			throws CheckedServiceException {
	...
	@Override
	public MaterialProjectEditor getMaterialProjectEditorByMaterialIdAndUserId(Long materialId, Long userId)
			throws CheckedServiceException {
		MaterialProjectEditor materialProjectEditor = new MaterialProjectEditor(materialId, userId);
		return materialProjectEditorDao.getMaterialProjectEditorByMaterialIdAndUserId(materialProjectEditor);
	}
}
