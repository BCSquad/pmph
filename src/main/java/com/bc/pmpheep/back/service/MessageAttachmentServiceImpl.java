...
public class MessageAttachmentServiceImpl implements MessageAttachmentService {
	...
	@Override
	public MessageAttachment addMessageAttachment(MessageAttachment messageAttachment) throws CheckedServiceException {
	...
	@Override
	public Integer updateMessageAttachment(MessageAttachment messageAttachment) throws CheckedServiceException {
		if (ObjectUtil.isNull(messageAttachment)) {
			throw new CheckedServiceException(CheckedExceptionBusiness.MESSAGE, CheckedExceptionResult.NULL_PARAM,
					"消息附件对象为空 ");
	...
	@Override
	public Integer deleteMessageAttachmentByAttachment(String[] attachment) throws CheckedServiceException {
