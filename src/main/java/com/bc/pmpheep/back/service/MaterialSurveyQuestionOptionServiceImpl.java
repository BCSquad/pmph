 ...
 */
@Service
public class MaterialSurveyQuestionOptionServiceImpl implements MaterialSurveyQuestionOptionService {

    @Autowired
    private MaterialSurveyQuestionOptionDao surveyQuestionOptionDao;
