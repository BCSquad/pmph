...
public interface PmphGroupService {
    ...
    /**
     * 
     * @param pmphGroup 主键ID
     * @return 影响行数
     * @throws CheckedServiceException
     */
    String deletePmphGroupById(PmphGroup pmphGroup, String sessionId)
    throws CheckedServiceException;

    /**
     * 更新小组持久化对象
     * 
     * @param pmphGroup 需要更新的小组实例
     */
     ...
     * @throws CheckedServiceException
     */
    Integer updatePmphGroup(MultipartFile file, PmphGroup pmphGroup)
     ...
     * @throws CheckedServiceException
     */
    List<PmphGroupListVO> listPmphGroup(PmphGroup pmphGroup, String sessionId)
    throws CheckedServiceException;
     ...
     * @throws CheckedServiceException
     */
    List<PmphGroupListVO> listPmphGroupFile(PmphGroup pmphGroup, String sessionId)
    throws CheckedServiceException;
     ...
     * 
     */
    String msgUploadFiles(MultipartFile file, HttpServletRequest request)
    throws CheckedServiceException, IOException;
