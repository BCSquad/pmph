...
public class DeclarationEtcBO {
    ...
    /**
     * @param isUtec the isUtec to set
     */
    ...
    /**
     * @param decEduExps the decEduExps to set
     */
    ...
    /**
     * @param decWorkExps the decWorkExps to set
     */
    ...
    /**
     * @param decTeachExps the decTeachExps to set
     */
    ...
    /**
     * @param decAcades the decAcades to set
     */
    ...
    /**
     * @param decLastPositions the decLastPositions to set
     */
    ...
    /**
     * @param decCourseConstructions the decCourseConstructions to set
     */
    ...
    /**
     * @param decNationalPlans the decNationalPlans to set
     */
    ...
    /**
     * @param decTextbooks the decTextbooks to set
     */
    ...
    /**
     * @param decResearchs the decResearchs to set
     */
    ...
    /**
     * @param decMonographs the decMonographs to set
     */
    ...
    /**
     * @param publishRewards the publishRewards to set
     */
    ...
    /**
     * @param decScis the decScis to set
     */
    ...
    /**
     * @param decClinicalRewards the decClinicalRewards to set
     */
    ...
    /**
     * @param decAcadeRewards the decAcadeRewards to set
     */
    ...
    /**
     * @param decExtensionVOs the decExtensionVOs to set
     */
