...
public class UserMessage implements java.io.Serializable {
	...
	public UserMessage(String msgId, String title, Short msgType, Long senderId, Short senderType, Long receiverId,
			Short receiverType, Boolean isRead, Boolean isWithdraw, Boolean isDeleted, Timestamp gmtCreate,
			Timestamp gmtUpdate) {
		super();
		this.msgId = msgId;
		this.title = title;
	 ...
	 *            收收人类型
	 */
	public UserMessage(String msgId, Short msgType, Long senderId, Short senderType, Long receiverId,
			Short receiverType) {
		super();
		this.msgId = msgId;
		this.msgType = msgType;
	...
	public String toString() {
		return "{id:" + id + ", msgId:" + msgId + ", msgType:" + msgType + ", senderId:" + senderId + ", senderType:"
				+ senderType + ", receiverId:" + receiverId + ", receiverType:" + receiverType + ", isRead:" + isRead
				+ ", isWithdraw:" + isWithdraw + ", isDeleted:" + isDeleted + ", gmtCreate:" + gmtCreate
				+ ", gmtUpdate:" + gmtUpdate + "}";
	}
