...
public class PmphUser implements java.io.Serializable {
	...
	public PmphUser(String username, String password, Boolean isDisabled, String realname, Long departmentId,
			String handphone, String email, String avatar, String note, Integer sort, Boolean isDeleted, Date gmtCreate,
			Date gmtUpdate, Short loginType) {
		this.username = username;
		this.password = password;
	...
	public String toString() {
		return "PmphUser [id=" + id + ", username=" + username + ", password=" + password + ", isDisabled=" + isDisabled
				...
				+ email + ", avatar=" + avatar + ", note=" + note + ", sort=" + sort + ", isDeleted=" + isDeleted
				+ ", gmtCreate=" + gmtCreate + ", gmtUpdate=" + gmtUpdate + ", loginType=" + loginType + "]";
	}
