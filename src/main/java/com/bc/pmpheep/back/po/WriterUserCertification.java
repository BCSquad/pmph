...
public class WriterUserCertification implements Serializable {
	...
	/** full constructor */
	public WriterUserCertification(Long userId, Long orgId, String handphone,
			String idcard, Short progress, String cert, Timestamp gmtCreate,
			Timestamp gmtUpdate) {
		this.userId = userId;
		this.orgId = orgId;
	...
	public String toString() {
		return "{id:" + id + ", userId:" + userId + ", orgId:" + orgId
				+ ", handphone:" + handphone + ", idcard:" + idcard
