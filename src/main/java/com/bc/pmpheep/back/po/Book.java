...
public class Book implements Serializable {
    ...
    public Book(String bookname, String isbn, String sn, String author, String publisher,
    String lang, Integer revision, Long type, Date publishDate, String reader, Double price,
    Double score, String buyUrl, String imageUrl, String pdfUrl, Long clicks, Long comments,
    Long likes, Long bookmarks, Boolean isStick, Integer sort, Timestamp deadlineStick,
    Boolean isNew, Integer sortNew, Timestamp deadlineNew, Boolean isPromote, Integer sortPromote,
    Timestamp deadlinePromote, Long sales, Boolean isOnSale, Timestamp gmtCreate,
    Timestamp gmtUpdate) {
        super();
        this.bookname = bookname;
        this.isbn = isbn;
    ...
    public String toString() {
        return "book [id=" + id + ", bookname=" + bookname + ", isbn=" + isbn + ", sn=" + sn
               + ", author=" + author + ", publisher=" + publisher + ", lang=" + lang
               + ", revision=" + revision + ", type=" + type + ", publishDate=" + publishDate
               + ", reader=" + reader + ", price=" + price + ", score=" + score + ", buyUrl="
               + buyUrl + ", imageUrl=" + imageUrl + ", pdfUrl=" + pdfUrl + ", clicks=" + clicks
               + ", comments=" + comments + ", likes=" + likes + ", bookmarks=" + bookmarks
               + ", isStick=" + isStick + ", sort=" + sort + ", deadlineStick=" + deadlineStick
               + ", isNew=" + isNew + ", sortNew=" + sortNew + ", deadlineNew=" + deadlineNew
               + ", isPromote=" + isPromote + ", sortPromote=" + sortPromote + ", deadlinePromote="
               + deadlinePromote + ", sales=" + sales + ", isOnSale=" + isOnSale + ", gmtCreate="
