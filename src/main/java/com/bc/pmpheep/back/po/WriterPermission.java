...
public class WriterPermission implements Serializable {
	 ...
	 * @param gmtUpdate
	 */
	public WriterPermission(Long parentId, String path, String permissionName, String menuName, String url,
			boolean isDisabled, String note, Integer sort, Date gmtCreate, Date gmtUpdate) {
		super();
	...
	public String toString() {
		return "WriterPermission {id=" + id + ", parentId=" + parentId + ", path=" + path + ", permissionName="
				+ permissionName + ", menuName=" + menuName + ", url=" + url + ", isDisabled=" + isDisabled + ", note="
